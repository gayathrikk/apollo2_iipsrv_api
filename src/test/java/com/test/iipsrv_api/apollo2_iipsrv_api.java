...
public class apollo2_iipsrv_api {
    ...
    public void iipsrv() {
        Response response1 = RestAssured
                ...
                .basic("admin", "admin")
                .when()
                .get("https://preprod.humanbrain.in//iipsrv/fcgi-bin/iipsrv.fcgi?FIF=/ddn/storageIIT/humanbrain/analytics/222/NISL/B_223_FB74-SL_316-ST_NISL-SE_946_compressed.jp2&WID=1024&GAM=3.2&MINMAX=1:0,141&MINMAX=2:0,153&MINMAX=3:117,255&JTL=0,0");
